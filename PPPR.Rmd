...
nightmoves <- safeGraph %>% 
  filter(placekey %in% as.list(possible_businesses$placekey))
...
odmatrix.geo <- odmatrix %>% 
  ...
  st_as_sf()
odmatrix.geo <- odmatrix.geo[philly,]

```

```{r traim  safeGraph into district 789}
