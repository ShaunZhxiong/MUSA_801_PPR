...
print(unique(program2021.clean$Facility))
```

```{r}
print(unique(propertyParent$PUBLIC_NAME))
```
...
for (i in c(1:42)){
  for (g in c(1:524)){
    if (grepl(keyProgram[i],keyProperty[g])){
      keyProgram[i] = keyProperty[g]
    }
  }
}
