...
plot_grid(p1, p2, labels = c("Distribution Histogram of MAE for Different Census Block Groups",
...
plot_grid(p1, p2, labels = c("Distribution Histogram of MAE for Different Parks $ Rec Centers",
