...
```{r SA8_Events 2,fig.height = 5,message = FALSE, warning = FALSE, results='hide',out.width = '80%',fig.align = 'center',fig.cap = 'Figure2.2.7 Visitor Counts by Week and Activity Categories in District 9'}
...
```{r visit Count map,fig.height = 8,message = FALSE, warning = FALSE,out.width ='80%',fig.align = 'center',fig.cap = 'Figure3.2.1 Map of Visit Counts in Device Panel',results='hide'}
sumVisit <- visitCount %>%
...
```{r Winter R square map2, fig.height = 8,message = FALSE, warning = FALSE,out.width ='80%',fig.align = 'center',fig.cap = 'Figure6.7.6 Fitting R square Distribution Map in Winter Model',results='hide'}
winterPlot <- 
  parameter %>% 
  drop_na() %>% 
...
```{r hist of MAPE for cbgS,fig.height = 4,fig.cap = 'Figure7.3.2.1 MAPE Distribution Histgram for Census Block Groups'}
...
```{r MAPE map for cbgs,fig.height = 8,message = FALSE, warning = FALSE,out.width ='80%',fig.align = 'center',fig.cap = 'Figure 7.3.2.2 MAPE Distribution Map for Census Block Groups'}
  ggplot() + 
...
```{r MAPE map for cv,fig.height = 4, out.width ='100%',fig.cap = 'Figure 7.4.1 MAPE from Cross-Validation for PPR Districts (Left: Before-Optimization, Right:After-Optimization'}
