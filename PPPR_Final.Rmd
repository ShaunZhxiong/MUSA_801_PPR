...
```{r hist of MAPE for cbgS,,fig.height = 4,message = FALSE, warning = FALSE,out.width ='80%',fig.align = 'center',fig.cap = 'Figure7.3.2.1 Distribution Histogram of MAE & MAPE for Different Census Block Groups'}
...
#   ungroup()
# 
# st_write(cv_group_result,"data/output/cv_group_result1.csv")
cv_group_result <- st_read("data/output/cv_group_result1.csv")
```
...
# st_write(cv_group_result2,"data/output/cv_group_result2.csv")
cv_group_result2 <- st_read("data/output/cv_group_result2.csv")
```
