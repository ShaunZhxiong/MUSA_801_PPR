...
```{r calculate attractiveness, message=FALSE, warning=FALSE, echo=FALSE, results='hide', fig.height = 12,out.width ='200%',fig.align = 'center',fig.cap = 'Figure6.2.1 Summary of Attractiveness' }
attractivenssData <- 
  modelData %>% 
...
```{r centrality, fig.height = 3,message = FALSE, warning = FALSE, echo=FALSE, results='hide', out.width ='100%',fig.align = 'center',fig.cap = 'Figure6.5.1 Total Vistors of Related Brand With Naics'}
...
```{r, 2model fit parameter, fig.height = 3,message = FALSE, warning = FALSE,out.width ='80%',fig.align = 'center',fig.cap = 'Figure6.6.2 Histogram of data set2'}
...
We divide the data based on record dates into four seasons and run individual model to predict the probability in each season. The red line represent temperature while the orange line represent number of visitors. Both number are exaggerate 500 times for visualization.

With limited data pattern after assigning to four seasons, some Census Block Group shows blank areas in map in different season models. The situation is better when we aggregate results and run the Huff model for the whole year. We may consider to use warm-day model from April to October to improve the valid data. And we will discuss it with PPR staffing and see their demands of the use case. 

```{r temporal chart, fig.height = 4,message = FALSE, warning = FALSE,out.width ='100%',fig.align = 'center',fig.cap = 'Figure6.7.1 Temporal Chart of vistor and temperature'}
# temperature data
weather.Data <-
...
```{r missing data for model, fig.height = 6,message = FALSE, warning = FALSE, results='hide',out.width = '80%',fig.align = 'center',fig.cap = 'Figure6.7.2 Census Block Group with Missing Probability'}
# calculate probability 
