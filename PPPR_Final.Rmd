...
ggmap(base_map) + 
  ...
  labs(title = "Figure1.1.1 Location of PPR Districts and Pilot Service Areas", 
       subtitle = "",
       x="",y="")+
  mapTheme()
```
...
```{r spatially distribution of sg bias clusters,fig.height = 12,message = FALSE, warning = FALSE,out.width ='100%',fig.align = 'center',fig.cap = 'Figure4.1.2 Map of Bias Type of SafeGraph Data'}
...
```{r add visits frequency level into the model, message=FALSE, warning=FALSE,fig.height = 8,fig.cap = 'Figure R-squared Distribution Histgram for Optimized Model'}
...
```{r bar plot for errr in different frequency level,fig.height = 8,fig.cap = 'Figure Error among Different Route Visit Frequency Level'}
...
```{r hist of MAPE for cbgS,fig.height = 8,fig.cap = 'Figure MAPE Distribution Histgram for Census Block Groups'}
...
```{r MAPE map for cbgs,fig.height = 8,message = FALSE, warning = FALSE,out.width ='80%',fig.align = 'center',fig.cap = 'Figure7.3.2.2 MAPE Distribution Map for Census Block Groups'}
  ggplot() + 
...
```{r map of MAPE for parks,fig.height = 4,message = FALSE, warning = FALSE,out.width ='80%',fig.align = 'center',fig.cap = 'Figure7.3.2.3 Distribution Histogram of MAE & MAPE for Different Parks & Rec Centers'}
ggplot() + 
  geom_sf(data=left_join(predictionResult_group, CensusPoly, by=c("origin"="GEOID")) %>% st_sf(),
          color="black",size=0.05,aes(fill = q5(MAPE)))+
...
```{r hist of MAPE for parks,fig.height = 8,fig.cap = 'Figure MAE & MAPE Distribution Histgram for Different Parks $ Rec Centers'}
...
```{r MAPE map for cv,fig.height = 8,fig.cap = 'Figure MAPE from Cross-Validation for PPR Districts'}
