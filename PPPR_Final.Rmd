...
```{r hist of MAPE for cbgS,fig.height = 8}
hist(error %>% filter(MAPE<=10) %>% pull(MAPE), breaks=100, 
     xlab="MAPE", main="Distribution Histogram of MAPE for Different Block Groups")
```

```{r MAPE map for cbgs,fig.height = 8,message = FALSE, warning = FALSE,out.width ='80%',fig.align = 'center',fig.cap = 'Figure MAPE Distribution Map for Census Block Groups'}
...
```{r hist of MAPE for parks,fig.height = 8}
...
```{r MAPE map for parks,fig.height = 8,message = FALSE, warning = FALSE,out.width ='80%',fig.align = 'center',fig.cap = 'Figure MAPE Distribution Map for Parks'}
