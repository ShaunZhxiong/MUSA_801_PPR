...
print(paste0("MAE is ",round(mean(error$MAE,na.rm=T),4)))
...
outcomeAnalysis(parameterDrop,"Final Optimal Model: Dropping NA probability, \n
                using PCA, and taking visits frequency level into consideration")
