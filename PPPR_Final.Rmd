...
```{r openData_pprDistrictAndServiceArea, fig.align='center', fig.cap=, fig.height=8, message=FALSE, warning=FALSE, out.width='80%', results='hide'}
...
4 methods to do feature engineering
...
```{r huff model fit parameter, fig.height = 3,message = FALSE, warning = FALSE,out.width ='80%',fig.align = 'center',fig.cap = 'Histogram of parameter set1'}
##### Prepare data
