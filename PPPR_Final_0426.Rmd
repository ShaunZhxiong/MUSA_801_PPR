...
***Over-programmed facilities***: They are shown as **pink** points where **many permits** but **few foot traffic**, since they are usually **community centers** who support **group events**.
...
#### 5.8 Train and Test in SCENARIO 1
...
#### 5.9 Train and Test in SCENARIO 3
