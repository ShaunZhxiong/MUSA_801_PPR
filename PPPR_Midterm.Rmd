...
```{r facility with many permits but low visits in district 9}
# visitCount789 <- 
...
```{r non-normal facility in cluster4, district 7}
# visitCount789 <- 
#   st_join(visitCount %>% st_transform(crs=4326),pprServiceArea%>% st_transform(crs=4326),left=TRUE) %>% 
#   filter(PPR_DIST %in% c(7,8,9))
# 
...
```{r GEP img, echo=FALSE,fig.height = 1,out.width = '35%',fig.align = 'center', fig.cap = 'Figure Matthias Baldwin Park'}
knitr::include_graphics("resources/imgaes/Stephen Girard Park.png")
```

```{r 2 GEP2 img, echo=FALSE,fig.height = 1,out.width = '35%',fig.align = 'center', fig.cap = 'Figure Matthias Baldwin Park'}
knitr::include_graphics("resources/imgaes/Stephen Girard Park2.png")
```

```{r 2 GEP dwell time ,fig.height = 5,message = FALSE, warning = FALSE,out.width ='75%',fig.align = 'center',fig.cap = 'Figure. Map of dwell time'}
sumVisit3 <- dwellTime %>% 
...
```{r GEP temperal pattern by day ,fig.height = 5,message = FALSE, warning = FALSE,out.width ='75%',fig.align = 'center',fig.cap = 'Figure. Map of dwell time'}
visitCount %>% 
  filter(placekey=='zzz-222@628-pm9-jn5') %>% 
  st_drop_geometry()%>%
  na.omit()%>%
...
```{r GEP temperal pattern by hour,fig.height = 5,message = FALSE, warning = FALSE,out.width ='75%',fig.align = 'center',fig.cap = 'Figure. Map of visit time'}
sumVisit <- visitHour %>% 
