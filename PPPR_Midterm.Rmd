...
header-includes:
  - \usepackage[font={large,it}, labelfont={bf}]{caption}
output:
  html_document: 
    toc: yes
    toc_depth: 5
...
```{r openData_pprDistrictAndServiceArea,fig.height = 10,message = FALSE, warning = FALSE, results='hide',out.width = '100%',fig.align = 'center',fig.cap = 'Figure1.1.1. Locations of PPR Districts and Service Areas'}
...
```{r programNpermit,fig.height = 8,message = FALSE, warning = FALSE, results='hide',out.width = '80%',fig.align = 'center',fig.cap = 'Figure2.1.1 Facilities w/ Programmed (red) & Permited (orange) Activities in Disdrict 7,8 & 9'}
...
```{r SA7_Events,fig.height = 8,message = FALSE, warning = FALSE, results='hide',out.width = '100%',fig.align = 'center',fig.cap = 'Figure2.2.3 Categories of Events in District7'}
...
```{r SA7_Events 2,fig.height = 8,message = FALSE, warning = FALSE, results='hide',out.width = '80%',fig.align = 'center',fig.cap = 'Figure2.2.4 Visitor Counts by Week and Activity Categories in District 7'}
...
```{r SA8_Events,fig.height = 8,message = FALSE, warning = FALSE, results='hide',out.width = '100%',fig.align = 'center',fig.cap = 'Figure2.2.6 Categories of Events in District8'}
...
```{r SA8_Events 2,fig.height = 8,message = FALSE, warning = FALSE, results='hide',out.width = '80%',fig.align = 'center',fig.cap = 'Figure2.2.7 Visitor Counts by Week and Activity Categories in District 8'}
...
```{r SA9_Events,fig.height = 8,message = FALSE, warning = FALSE, results='hide',out.width = '80%',fig.align = 'center',fig.cap = 'Figure2.2.9 Facility & Program Categories in District 9'}
...
```{r SAOthers_Events,fig.height = 8,message = FALSE, warning = FALSE, results='hide',out.width = '100%',fig.align = 'center',fig.cap = 'Figure2.3.1 Facility & Program Categories in other Districts'}
...
```{r update property and program data with placekey 2, echo=FALSE, fig.align='center', fig.height=8, message=FALSE, warning=FALSE, out.width='100%'}
...
```{r correlation matrix for cluster1, fig.height = 8,message = FALSE, warning = FALSE,out.width ='100%',fig.align = 'center',fig.cap = 'Figure3.1.1 Correlation Matrix of SafeGraph Bias'}
...
```{r temperal pattern by weekday,fig.height =8,message = FALSE, warning = FALSE,out.width ='100%',fig.align = 'center',fig.cap = 'Figure3.2.7 Distribution of weekday pattern by service area level'}
...
```{r temperal pattern by hour,fig.height = 8,message = FALSE, warning = FALSE,out.width ='100%',fig.align = 'center',fig.cap = 'Figure3.2.8 Distribution of hour pattern by service area level'}
...
```{r spatially distribution of sg bias clusters,fig.height = 8,message = FALSE, warning = FALSE,out.width ='80%',fig.align = 'center',fig.cap = 'Figure3.3.2 Map of Bias Type of SafeGraph Data'}
...
```{r Thomas B. Smith Recreation Center dwell time ,fig.height = 8,message = FALSE, warning = FALSE,out.width ='80%',fig.align = 'center',fig.cap = 'Figure3.3.3 Smith Rec Center Activity with Total'}
...
```{r Thomas B. Smith Recreation Center dwell time2 ,fig.height = 4,message = FALSE, warning = FALSE,out.width ='100%', fig.align = 'center',fig.cap = 'Figure3.3.4 Dwelling time and time distribution of Smith Rec Center Activity with Total'}
sumVisit <- dwellTime %>% 
...
```{r GEP img3, echo=FALSE,fig.height = 3,out.width = '80%',fig.align = 'center'}
knitr::include_graphics(c("resources/imgaes/Stephen Girard Park9 combined.png"))
```

```{r GEP temperal pattern by hour,fig.height = 8,message = FALSE, warning = FALSE,out.width ='100%',fig.align = 'center',fig.cap = 'Figure3.3.7 Temperal Vistis Pattern By Hour & Vistis Dwelling Time'}
sumVisit <- visitHour %>% 
...
# try no pca
noPCATogo <- attracGEO789 %>% dplyr::select(-DISTRICTID) %>% st_sf()
...
RealModelData <- huffDropProbWithLargeAttract %>% 
...
# nopca attempt
RealModelDataNopca <- huffWithnotPCA %>% 
  mutate(distance = as.numeric(distance),
  probability = as.numeric(probability))
...
# fit <- fit_parameter(data = RealModelDataNopca, 
#                            places = RealModelPlaces, 
#                            neighbor_data = convenientSurroundEffect,
#                            neighbor_id_column="placekey", 
#                            neighbor_attr_column ="visits",
#                            id_column="placekey", 
#                            attr_column =c("area","facilityNum","facilityArea",
#                                           "trailMiles","picnicTable","exerciseNum",
#                                           "swimmingPoolNum","spraygroundNum","hydrationNum",
#                                           "tennisCourtNum","playgroundNum","treeHeight",
#                                           "treeArea","programNum","permitNum",
#                                           "programCap","permitCap"), 
#                            distance_column="distance", 
#                            probability_column="probability",
#                            origin_column = "GEOID", 
#                            k=3)
