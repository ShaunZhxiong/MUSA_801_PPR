...
# should be replaced by calculateDistance.R
...
parameter <- fit_parameter(data = modelData, places=modelPlaces, id_column="placekey", attr_column="attr", distance_column="distance", probability_column="probability",origin_column = "origin", k=3)
