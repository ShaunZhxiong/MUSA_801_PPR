...
The Philadelphia Parks and Recreation department is responsible for hosting all sorts of programming in their facilities.
Currently their best understanding of demand for programming comes from existing programs data (like attendance) and some rudimentary data about park visits (eg. total trash collected). 
...
Marian Anderson Recreation Center hold more activities in athletic category, like soccer and baseball. The other two facilities hold more cultural activities, like art and music.
...
Athletic activities were hold from March to November while cultural and after school activities mostly took place in fall.
...
Laura Sims Skate House hold hockey and ice skating activities from October to May the next year, while Morris Recreation Center hosted more cultural activities like dance as well as athletic activities of gymnastics, tumbling and basketball from October to December.
...
ggplot(WeekVisit %>%filter(PPR_DISTRICT == 8)) +
  ...
  plotTheme()
```
Hockey and ice skating activities take place in fall, winter and spring, while cultural and after school are mainly hold in fall.
...
Athletic activities of basketball and aquatics mostly took place in Barry Playground and Pool and East Passyunk Community Center. Eastwick Regional Playground, and Thomas B. Smith Recreation Center are the most two popular facilities with activities of athletic, after school, cultural, educational, and other categories. 
...
Athletic activities took place throughout the whole year, while other category of activities, like older adults and mentoring, were hold in the 2nd half of the year. Cultural activities, like art, dance, music, usually suspended in summer.
...
**cluster3 'zzz-222\@63s-dvq-5fz' 'zzz-222\@628-pm9-jn5' 'zzw-222\@628-pg9-tgk' 'zzz-222@628-pm7-nnq'** (choose one or more)**:** perform well in sg data (dwell and visits), but not more permit plans
...
```{r Thomas B. Smith Recreation Center img, echo=FALSE,fig.height = 1,out.width = '35%',fig.align = 'center', fig.cap = 'Figure Matthias Baldwin Park'}
knitr::include_graphics("resources/imgaes/Thomas B. Smith Recreation Center.png")
```

```{r Thomas B. Smith Recreation Center2 img, echo=FALSE,fig.height = 1,out.width = '35%',fig.align = 'center', fig.cap = 'Figure Matthias Baldwin Park'}
knitr::include_graphics("resources/imgaes/SmithRecCenter2.jpg")
```

```{r Thomas B. Smith Recreation Center dwell time ,fig.height = 5,message = FALSE, warning = FALSE,out.width ='75%',fig.align = 'center',fig.cap = 'Figure. Program'}
...
```{r Thomas B. Smith Recreation Center dwell time2 ,fig.height = 5,message = FALSE, warning = FALSE,out.width ='75%',fig.align = 'center',fig.cap = 'Figure. Map of dwell time'}
sumVisit <- dwellTime %>% 
...
```{r Thomas B. Smith Recreation Center temperal pattern by day ,fig.height = 5,message = FALSE, warning = FALSE,out.width ='75%',fig.align = 'center',fig.cap = 'Figure. Map of dwell time'}
visitCount %>% 
  filter(placekey=='zzw-222@628-pm7-rtv') %>% 
  st_drop_geometry()%>%
  na.omit()%>%
...
```{r Thomas B. Smith Recreation Center temperal pattern by hour,fig.height = 5,message = FALSE, warning = FALSE,out.width ='75%',fig.align = 'center',fig.cap = 'Figure. Map of visit time'}
sumVisit <- visitHour %>% 
  filter(placekey=='zzw-222@628-pm7-rtv') %>% 
  dplyr::select(-month) %>% 
  group_by(hour) %>%
...
Girard Estates Park is a representative case of non-normal facility with low permits, high visits and long dwell time. According to permit records, yoga is the only activity applied for permit 13:00-14:00 every Sunday from April to September. No other programs are scheduled by the PPR. However, it is a super active facility and important open space for local community to use. 

[Click here](https://www.girardestateneighbors.org/events-committee) for more information.


```{r GEP img, echo=FALSE,fig.height = 1,out.width = '35%',fig.align = 'center', fig.cap = 'Figure Girard Estates Park Pic1'}

knitr::include_graphics(c("resources/imgaes/Stephen Girard Park.png", "resources/imgaes/Stephen Girard Park-1.png" ))
...
```{r GEP temperal pattern by day ,fig.height = 5,message = FALSE, warning = FALSE,out.width ='75%',fig.align = 'center',fig.cap = 'Figure. Temperal Vistis Pattern By Day'}
...
```{r GEP img, echo=FALSE,fig.height = 1,out.width = '35%',fig.align = 'center', fig.cap = 'Figure Girard Estates Park Pic2'}

knitr::include_graphics(c("resources/imgaes/Stephen Girard Park9.png", "resources/imgaes/Stephen Girard Park-easter.jpg" ))

```


```{r GEP temperal pattern by hour,fig.height = 5,message = FALSE, warning = FALSE,out.width ='75%',fig.align = 'center',fig.cap = 'Figure. Temperal Vistis Pattern By Hour'}
sumVisit <- visitHour %>% 
...
```{r 2 GEP dwell time ,fig.height = 5,message = FALSE, warning = FALSE,out.width ='75%',fig.align = 'center',fig.cap = 'Figure. Vistis Dwell Time '}
...
```{r GEP img, echo=FALSE,fig.height = 1,out.width = '35%',fig.align = 'center', fig.cap = 'Figure Girard Estates Park Pic3'}

knitr::include_graphics(c("resources/imgaes/Stephen Girard-concert.jpg", "resources/imgaes/Stephen Girard Park5.png" ))
```
