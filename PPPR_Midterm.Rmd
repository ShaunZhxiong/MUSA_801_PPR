...
```{r spatially distribution of sg bias clusters,fig.height = 5,message = FALSE, warning = FALSE,out.width ='75%',fig.align = 'center',fig.cap = 'Figure14. Map of Bias Type of SafeGraph Data'}
...
**cluster3 'zzz-222\@63s-dvq-5fz' 'zzz-222\@628-pm9-jn5' 'zzw-222\@628-pg9-tgk' '[zzz-222\@628-pm7-nnq](mailto:zzz-222@628-pm7-nnq){.email}'** (choose one or more)**:** perform well in sg data (dwell and visits), but not more permit plans
...
```{r GEP img2, echo=FALSE,fig.height = 1,out.width = '35%',fig.align = 'center', fig.cap = 'Figure Girard Estates Park Pic2'}
...
```{r GEP img3, echo=FALSE,fig.height = 1,out.width = '35%',fig.align = 'center', fig.cap = 'Figure Girard Estates Park Pic3'}
