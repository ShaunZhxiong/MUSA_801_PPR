...
#### Limitation Analysis and Data Rectification 
...
visitIntegrated <- st_read("data/output/visitIntegrated.GeoJSON") %>% 
  rename(c("<5"="X.5",">240"="X.240","11-20"="X11.20","121-240"="X121.240","21-60"="X21.60","5-10"="X5.10","61-120"="X61.120" ))
...
cluster1_mean <- aggregate(visitIntegrated %>% 
                             ...
                             st_drop_geometry(),
                       by=list(visitIntegrated$cluster),
                       FUN=mean) %>% 
  rename(c("cluster"="Group.1"))
