...
By incorporating this novel dataset, we can find the target facilities whose visit counts is inconsistent with its scheduled programs and events. With understanding of the imbalance between demand and supply, we can adjust the quantity of programs and events, like increasing number in low-supplied facilities and reducing number in over-supplied facilities. Finally, we will validate the adjustment with the most recent SafeGraph data and see if it make demand and supply balance.
...
palette3 <- c("#f9b294","#f2727f","#c06c86")
...
```{r openData_pprDistrictAndServiceArea,fig.height = 8,message = FALSE, warning = FALSE, results='hide',out.width = '80%',fig.align = 'center',fig.cap = 'Figure1.1.1. Locations of PPR Districts and Service Areas'}
...
```{r programNpermit,fig.height = 6,message = FALSE, warning = FALSE, results='hide',out.width = '80%',fig.align = 'center',fig.cap = 'Figure2.1.1 Facilities w/ Programmed (red) & Permited (orange) Activities in Disdrict 7,8 & 9'}
...
```{r SA7_Events,fig.height = 5,message = FALSE, warning = FALSE, results='hide',out.width = '80%',fig.align = 'center',fig.cap = 'Figure2.2.3 Categories of Events in District7'}
...
```{r SA8_Events,fig.height = 5,message = FALSE, warning = FALSE, results='hide',out.width = '80%',fig.align = 'center',fig.cap = 'Figure2.2.6 Categories of Events in District8'}
...
ggplot(sumVisit)+
  ...
  scale_size_continuous(range = c(1, 6),name = "Visits")+
  mapTheme()+
  theme(legend.position = "bottom",
...
```{r calculate large attractiveness PCA, fig.height = 12,message = FALSE, warning = FALSE,out.width ='200%',fig.align = 'center',fig.cap = 'Figure6.1.1 Summary of Attractiveness'}
attractivenssData <- 
  modelData %>% 
...
```{r calculate small attractiveness PCA, fig.height = 6,message = FALSE, warning = FALSE,out.width ='80%',fig.align = 'center',fig.cap = 'Figure6.1.2 Correlation Matrix of Attractiveness'}
...
```{r PCAcomponet, fig.height = 6,message = FALSE, warning = FALSE,out.width ='80%',fig.align = 'center',fig.cap = 'Figure6.1.3 Primary Components of Large Attractiveness'}
...
```{r PCAcomponet2, fig.height = 6,message = FALSE, warning = FALSE,out.width ='80%',fig.align = 'center',fig.cap = 'Figure6.1.3 Primary Components of Small Attractiveness'}
...
```{r CentralityEffect, fig.height = 6,message = FALSE, warning = FALSE,out.width ='80%',fig.align = 'center',fig.cap = 'Figure6.1.5 Total Vistors of Related Brand With Naics'}
...
```{r Centrality2, fig.height = 6,message = FALSE, warning = FALSE,out.width ='80%',fig.align = 'center',fig.cap = 'Figure6.1.6 Overlay Map of Parks(red), Restaurants(purple) and Convinient Stores(orange)'}
...
ggplot() +
  ...
  geom_sf(data=parksSurroundDot,aes(geometry=geometry),color = palette3[2],fill = palette3[2],alpha = 1, size = 1) +
  # facet_wrap(~label)+
  mapTheme()+
  theme(legend.position = "bottom",
        legend.key.width = unit(0.5, 'cm'),
