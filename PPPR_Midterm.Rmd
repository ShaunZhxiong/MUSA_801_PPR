...
```{r update property and program data with placekey,fig.height = 5,message = FALSE, warning = FALSE,out.width = '75%',fig.align = 'center',fig.cap = 'Figure4. Comparison between all PPR properties and sucessfully joined properties'}
...
```{r correlation matrix for cluster1, fig.height = 5,message = FALSE, warning = FALSE,out.width ='75%',fig.align = 'center',fig.cap = 'Figure5. Correlation Matrix of SafeGraph Bias'}
...
<<<<<<< Updated upstream
```{r clusplot1, fig.height = 5,message = FALSE, warning = FALSE,out.width ='75%',fig.align = 'center',fig.cap = 'Figure6. Cluster Plot with Main Component'}
...
```{r component analysis1, fig.height = 5,message = FALSE, warning = FALSE,out.width ='75%',fig.align = 'center',fig.cap = 'Figure7. Parallel Analysis Scree Plots'}
...
```{r visit Count map,fig.height = 5,message = FALSE, warning = FALSE,out.width ='75%',fig.align = 'center',fig.cap = 'Figure8. Map of Visit Counts in Device Panel'}
sumVisit <- visitCount %>%
...
From the Figure8 we can see that people frequently visit facilities in the city center
